      ...
      >
        <div className="flex-1">
          <p className="text-zinc-600 dark:text-zinc-400">
            I'm a high school student and developer primarily working within the
            Swift ecosystem. Building slick software—without the bugs.
            Hopefully. Currently developing SuperCorners and MenuScores.
          </p>
        </div>
      </motion.section>
