export const metadata = {
  ...
  openGraph: {
    images: ['../LiveScores.webp'],
  },
}

<Cover
  src="../LiveScores.webp"
  alt="Sportssync Live Scores Menubar Command"
  caption="New Live Scores Menubar Command"
/>

# Sportssync Developer Blog #2
...
<a
  href="https://github.com/daniyalmaster693/sportssync/blob/main/CHANGELOG.md"
  aria-label="Sportssync Raycast Store Page"
  target="_blank"
>
...
<Cover src="/Sportssync Commands.webp" alt="Preference Panel Configuration" />

- Favorite Team Dashboard Tracker Preview

<Cover src="/Sportssync-3.webp" alt="Favorite Team Dashboard Preview" />

- Live Scores Menubar Preview

<Cover src="/Sportssync-4.webp" alt="Live Scores Menubar Command Preview" />

- Tracker Injuries View Preview

<Cover src="/Sportssync-6.webp" alt="Tracker Injuries Preview" />

- Tracker Articles View Preview

<Cover src="/Sportssync-5.webp" alt="Tracker News View" />

- Tracker Transactions Preview

<Cover src="/Sportssync-7.webp" alt="Tracker Transactions View" />

- Scores and Schedule Command with new and context aware actions

<Cover src="/Sportssync Actions.webp" alt="Updated Context Aware Actions" />
