export const metadata = {
  ...
  openGraph: {
    images: ['../my-raycast-setup.webp'],
  },
}

<Cover src="../my-raycast-setup.webp" alt="My Raycast Setup" />
...
<Cover src="/Raycast Extensions.webp" alt="Raycast Extensions" />
...
- Show Periodic Table
- Spell
- [Sportssync (made by me!)](https://www.raycast.com/daniyal_master/sportssync)
- Spotify Controls
- Raytyping
- System Monitor
- Test Internet Speed
...
<Cover src="/Script Commands.webp" alt="Script Commands Window" />
...
<Cover
  src="/Spotify Restart Screenshot.webp"
  alt="Spotify Restart Screenshot"
/>
