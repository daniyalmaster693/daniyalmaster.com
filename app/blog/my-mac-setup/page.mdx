export const metadata = {
  ...
  openGraph: {
    images: ['../my-mac-setup.webp'],
  },
}

<Cover src="../my-mac-setup.webp" alt="My Mac Setup" />
...
<Cover src="/Launchpad Apps.webp" alt="Launchpad Apps" />
...
<Cover src="/Visual Studio Code.webp" alt="Visual Studio Code" />
...
<Cover src="/Hot Corners.webp" alt="Launchpad Apps" />
...
<Cover src="/Apple Shortcuts Startup Apps.webp" alt="Apple Shortcut" />
