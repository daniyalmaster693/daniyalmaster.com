export const metadata = {
  ...
  openGraph: {
    images: ['../Sportssync-1.webp'],
  },
}

<Cover
  src="../Sportssync-1.webp"
  alt="Sportssync Past Scores Feature Screenshot"
  caption="New Past Scores Feature"
/>

# Sportssync Developer Blog #1
...
<Cover
  src="../Updated Scores and Schedule Command.webp"
  alt="Sportssync Scores and Schedule Screenshot"
/>

- Past Scores in the NHL Scores and Schedule Command and New Checkmark Icons:

<Cover
  src="../Past Scores Feature.webp"
  alt="Sportssync Past Scores Feature Screenshot"
/>
...
<Cover
  src="../Updated Standings.webp"
  alt="Sportssync Updated Standings Screenshot"
/>

- Headline Category Indicators for the F1 News Command, and New Calendar Icons:

<Cover src="../Updated News.webp" alt="Sportssync Updated News View" />
